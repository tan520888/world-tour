...
(function(){
  ...
  function loadManagerBoard(){if(!document.querySelector('script[src^="/manager-board.js"]')){var s=document.createElement('script');s.src='/manager-board.js?v=1';s.defer=true;document.body.appendChild(s)}}
  ...
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',loadManagerBoard);else setTimeout(loadManagerBoard,300);
})();